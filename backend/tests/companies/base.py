...
class CompaniesTestCase(MockedAppTestCase):
    """Base for async companies tests. Redis and DB are mocked.
    ...
    tests/companies/test_location_reference.py) override this per-test.
    """
